...
setup(
    ...
    #
    # And where it will live on PyPI: https://pypi.org/project/instantgrade/
    #
    ...
    description='An automated evaluation framework for Python notebooks and Excel assignments',  # Optional
    ...
    url="https://github.com/chandraveshchaudhari/evaluator",  # Optional
    ...
    # above.
    author_email='chandraveshchaudhari@gmail.com',  # Optional
    ...
    # larger catalog.
    keywords='evaluation, grading, jupyter, notebook, excel, education, automated-grading, assignment-evaluation',  # Optional
    ...
    # platform.
    #
    # For example, the following would provide a command called `instantgrade` which
